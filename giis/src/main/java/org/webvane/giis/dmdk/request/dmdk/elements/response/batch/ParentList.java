...
public class ParentList {
    ...
    @XmlElement(name = "isAllQuantityAndWeight", namespace = "urn://xsd.benemed/batch/3.0")
    ...
    @XmlElement(name = "gemstone", namespace = "urn://xsd.benemed/batch/3.0")
    private Gemstone gemstone;
    @XmlElement(name = "weightRaw", namespace = "urn://xsd.benemed/batch/3.0")
