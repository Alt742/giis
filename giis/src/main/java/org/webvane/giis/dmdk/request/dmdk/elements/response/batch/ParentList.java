...
public class ParentList {
    ...
    @XmlElement(name = "isAllQuantityAndWeight", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
    ...
    @XmlElement(name = "gemstone", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
    private Gemstone gemstone;
    @XmlElement(name = "weightRaw", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
