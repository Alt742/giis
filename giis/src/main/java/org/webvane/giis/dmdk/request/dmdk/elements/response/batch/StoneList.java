...
public class StoneList {
    ...
    private String type;
    @XmlElement(name = "classCode", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
    private String classCode;
    @XmlElement(name = "shape", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
    private String shape;
    @XmlElement(name = "quality", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
    private String quality;
    @XmlElement(name = "color", namespace = "urn://xsd.dmdk.goznak.ru/batch/3.0")
