...
public class Contractor {
    @XmlElement(name = "legal", namespace = "urn://xsd.benemed/contractor/1.0")
    private Legal legal;
    @XmlElement(name = "physical", namespace = "urn://xsd.benemed/contractor/1.0")
    private Physical physical;
    @XmlElement(name = "outer", namespace = "urn://xsd.benemed/contractor/1.0")
    private Outer outer;
    @XmlElement(name = "generic", namespace = "urn://xsd.benemed/contractor/1.0")
    private Generic generic;
    @XmlElement(name = "artist", namespace = "urn://xsd.benemed/contractor/1.0")
